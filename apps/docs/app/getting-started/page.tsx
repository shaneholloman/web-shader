  ...
  return (
    <div className="px-4 py-8 lg:px-8 lg:py-12 max-w-4xl mx-auto">
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-gray-100 mb-4" id="installation">
          Installation
        </h2>
      ...
      {/* Browser Support */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-gray-100 mb-4" id="browser-support">
          Browser Support
        </h2>
        <p className="text-gray-300 mb-4">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-4">
          <div className="p-4 rounded-lg bg-gray-900 border border-gray-800">
            <h3 className="font-semibold text-gray-100 mb-2">✅ Supported</h3>
          ...
          <div className="p-4 rounded-lg bg-gray-900 border border-gray-800">
            <h3 className="font-semibold text-gray-100 mb-2">⚠️ Limited</h3>
            <ul className="text-gray-400 text-sm space-y-1">
        ...
        <div className="p-4 rounded-lg bg-yellow-500/10 border border-yellow-500/20 text-yellow-200">
          <strong>Important:</strong> Always check <code>gpu.isSupported()</code> before initializing to handle unsupported browsers gracefully.
        </div>
      </section>

      {/* Basic Setup */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-gray-100 mb-4" id="basic-setup">
          Basic Setup
        </h2>
        <p className="text-gray-300 mb-4">
      ...
      {/* First Shader */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-gray-100 mb-4" id="first-shader">
          Your First Shader
        </h2>
        <p className="text-gray-300 mb-4">
        ...
        <div className="mt-4 p-4 rounded-lg bg-gray-900 border border-gray-800">
          <h3 className="font-semibold text-gray-100 mb-2">What&apos;s happening here?</h3>
          <ul className="text-gray-400 space-y-2">
            <li>
              <strong className="text-gray-200">Line 5:</strong> We create a <code>pass</code> — a fullscreen fragment shader.
            </li>
            <li>
              <strong className="text-gray-200">Line 8:</strong> <code>globals.resolution</code> gives us the canvas size.
            </li>
            <li>
              <strong className="text-gray-200">Line 9:</strong> <code>globals.time</code> is automatically updated each frame.
            </li>
            <li>
              <strong className="text-gray-200">Line 15:</strong> <code>draw()</code> renders the shader to the screen.
            </li>
          </ul>
        </div>
      </section>
      ...
      {/* React Integration */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-gray-100 mb-4" id="react-integration">
          React Integration
        </h2>
        <p className="text-gray-300 mb-4">
        ...
        <div className="mt-4 p-4 rounded-lg bg-primary-500/10 border border-primary-500/20 text-primary-200">
          ...
          <ul className="mt-2 space-y-1 text-sm">
            <li>• Use a <code>disposed</code> flag to prevent rendering after unmount</li>
            <li>• Clean up with <code>ctx.dispose()</code> in the effect cleanup</li>
            <li>• Handle resize events with <code>ctx.resize()</code></li>
          </ul>
        </div>
      </section>
      ...
      {/* Common Issues */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-gray-100 mb-4" id="common-issues">
          Common Setup Issues
        </h2>
        
        <div className="space-y-4">
          <div className="p-4 rounded-lg bg-gray-900 border border-gray-800">
            <h3 className="font-semibold text-gray-100 mb-2">❓ Canvas is blank</h3>
            <p className="text-gray-400 text-sm">
              Make sure you&apos;re calling <code>draw()</code> in a loop with <code>requestAnimationFrame</code>. Also check that the canvas has explicit dimensions.
            </p>
          </div>
          
          <div className="p-4 rounded-lg bg-gray-900 border border-gray-800">
            <h3 className="font-semibold text-gray-100 mb-2">❓ WebGPU not supported error</h3>
            <p className="text-gray-400 text-sm">
          ...
          <div className="p-4 rounded-lg bg-gray-900 border border-gray-800">
            <h3 className="font-semibold text-gray-100 mb-2">❓ Shader compilation errors</h3>
            <p className="text-gray-400 text-sm">
              WGSL is strictly typed. Make sure all variables have explicit types and function return types are specified. Enable <code>debug: true</code> for detailed errors.
            </p>
          </div>
          
          <div className="p-4 rounded-lg bg-gray-900 border border-gray-800">
            <h3 className="font-semibold text-gray-100 mb-2">❓ Low frame rate / poor performance</h3>
            <p className="text-gray-400 text-sm">
              Limit the device pixel ratio with <code>dpr: Math.min(window.devicePixelRatio, 2)</code> to avoid rendering at 4x resolution on high-DPI displays.
            </p>
          </div>
        </div>
      </section>
